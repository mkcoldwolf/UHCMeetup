package mitw.meetup.border.barrier;

import com.google.common.base.Predicate;
import com.google.common.collect.HashBasedTable;
import com.google.common.collect.Table;
import mitw.meetup.UHCMeetup;
import mitw.meetup.util.cuboid.Cuboid;
...
public class VisualiseHandler {
    ...
    public void handlePositionChanged(Player player, final World toWorld, final int toX, final int toY, final int toZ) {
        ...
        double x = UHCMeetup.getInstance().getGameManager().getBorder();
        double z = UHCMeetup.getInstance().getGameManager().getBorder();
